...
export default function PairPriceChart({
  ...
  var new_tokenIn = tokenIn == "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee" ? "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7" : tokenIn;
  var new_tokenOut = tokenOut == "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee" ? "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7" : tokenOut;
    ...
    datasets: [
      {
        label: label,
        data: prices,
        borderColor: () => { let bgColor = bgStatus > 0 ? 'rgb(139,118,255)' : 'rgb(255, 99, 132)'; return bgColor },
        ...
        backgroundColor: (context: ScriptableContext<'line'>) => {
          ...
          if (bgStatus > 0) {
            gradient.addColorStop(0, 'rgba(88, 65, 216, 1)');
            gradient.addColorStop(0.4, 'rgba(88, 65, 216, 0.3)');
            gradient.addColorStop(0.8, 'rgba(88, 65, 216, 0)');
            gradient.addColorStop(1, 'rgba(88, 65, 216, 0)');
          } else {
