      ...
      {address ? (
        <div className="flex items-center gap-3 sm:gap-6 lg:gap-8">
          <div className="relative">
            <Menu>
              <Menu.Button className="block h-10 w-[150px] overflow-hidden rounded-full border-3 border-solid border-white bg-gradient-to-r from-[#1e40af] to-[#1e3a8a] shadow-main transition-all hover:-translate-y-0.5 hover:shadow-large dark:border-gray-700">
                {address.slice(0, 6)}
                {'...'}
